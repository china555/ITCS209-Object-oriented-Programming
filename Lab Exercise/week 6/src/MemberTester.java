public class MemberTester {
  public static void main(String[] args) {
    ...
    pro.addCollaborator("alan@turing");
    pro.addCollaborator("bill@gates");
    pro.addCollaborator("steve@jobs");
    pro.addCollaborator("mark@zuckerberg");
    pro.removeCollaborator("steve@job");
    pro.removeCollaborator("steve@jobs");
    System.out.println("*******************************");
